    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(choices=[(0, games.models.PenaltyTag.Type['yellow']), (1, games.models.PenaltyTag.Type['red']), (2, games.models.PenaltyTag.Type['general'])], default='general', max_length=127)),
                ('description', models.TextField()),
                ('instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', related_query_name='tag', to='games.penalty')),
            ],
            options={
                'ordering': ['-created'],
            },
